    ...
    <div class="text-success  login">Login</div>
     ...
     <section id="footer" class="myfooter">
          <div class="container">
               ...
               <div class="row">
                    <div class="col-xs-12 col-ssm-12 col-md-12 mt-2 mt-sm-2 text-center">
                         <p><u><a href="https://www.agrocraft.com/">HOMEFROMHARVEST</a></u>  is an Ecommerce platform for farmers</p>
                         <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.google.com" target="_blank">HOMEFROMHARVEST</a></p>
                    </div>
                    </hr>
               </div>
          </div>
